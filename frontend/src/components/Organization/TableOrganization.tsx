...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/organization/organizationSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureOrganizationCols';
...
const TableSampleOrganization = ({
  ...
  useEffect(() => {
    if (organizationNotify.showNotification) {
      notify(
        organizationNotify.typeNotification,
        organizationNotify.textNotification,
      );
    }
  }, [organizationNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/organization/organization-view/?id=${id}`);
  };
...
export default TableSampleOrganization;
