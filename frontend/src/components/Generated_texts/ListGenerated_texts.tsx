  ...
  return (
    <>
      <div className='relative overflow-x-auto p-4 space-y-4'>
            ...
            <CardBox hasTable key={item.id} className={'rounded'}>
              <div className={'flex items-center overflow-hidden'}>
                ...
                >
                  ...
                  <div className={'flex-1 px-3'}>
                    <p className={'text-xs text-gray-500'}>GeneratedText</p>
                    <p className={'line-clamp-2'}>{item.generated_text}</p>
                  </div>
                </div>
                <ListActionsPopover
                  onDelete={onDelete}
        ...
        {!loading && generated_texts.length === 0 && (
...
export default ListGenerated_texts;
