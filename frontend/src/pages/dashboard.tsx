...
const Dashboard = () => {
  ...
  const [generated_images, setGenerated_images] = React.useState('Loading...');
  const [generated_texts, setGenerated_texts] = React.useState('Loading...');
    ...
    <>
      ...
      <SectionMain>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6'>
          ...
          {hasPermission(currentUser, 'READ_GENERATED_IMAGES') && (
          ...
          {hasPermission(currentUser, 'READ_GENERATED_TEXTS') && (
            <Link href={'/generated_texts/generated_texts-list'}>
              <div className='rounded dark:bg-dark-900 bg-white border border-pavitra-400 dark:border-dark-700 p-6'>
                <div className='flex justify-between align-center'>
                  <div>
                    <div className='text-lg leading-tight text-gray-500 dark:text-gray-400'>
                  ...
                  <div>
                    <BaseIcon
                      ...
                      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                      // @ts-ignore
                      path={icon.mdiTextBox || icon.mdiTable}
                    />
                  </div>
                </div>
              </div>
