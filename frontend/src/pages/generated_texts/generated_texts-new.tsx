...
import { create } from '../../stores/generated_texts/generated_textsSlice';
...
Generated_textsNew.getLayout = function getLayout(page: ReactElement) {
  return (
    <LayoutAuthenticated permission={'CREATE_GENERATED_TEXTS'}>
      {page}
    </LayoutAuthenticated>
  );
};

export default Generated_textsNew;
