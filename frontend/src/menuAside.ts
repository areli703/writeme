...
const menuAside: MenuAsideItem[] = [
  ...
  {
    href: '/generated_images/generated_images-list',
    label: 'Generated images',
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    icon: icon.mdiImage ? icon.mdiImage : icon.mdiTable,
    permissions: 'READ_GENERATED_IMAGES',
  },
  {
    href: '/generated_texts/generated_texts-list',
    label: 'Generated texts',
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    icon: icon.mdiTextBox ? icon.mdiTextBox : icon.mdiTable,
    permissions: 'READ_GENERATED_TEXTS',
  },
  {
