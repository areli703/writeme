...
module.exports = class OrganizationsDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.generated_images_organization =
      await organizations.getGenerated_images_organization({
        transaction,
      });

    output.generated_texts_organization =
      await organizations.getGenerated_texts_organization({
        transaction,
      });
