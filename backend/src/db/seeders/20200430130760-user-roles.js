...
primary key ("roles_permissionsId", "permissionId")
    ...
    await queryInterface.bulkInsert('rolesPermissionsPermissions', [
...

      {
        ...
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('CREATE_GENERATED_IMAGES'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('READ_GENERATED_IMAGES'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('UPDATE_GENERATED_IMAGES'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('DELETE_GENERATED_IMAGES'),
      },

      {
        ...
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('CREATE_GENERATED_TEXTS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('READ_GENERATED_TEXTS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('UPDATE_GENERATED_TEXTS'),
      },
      {
        createdAt,
        updatedAt,
        roles_permissionsId: getId('User'),
        permissionId: getId('DELETE_GENERATED_TEXTS'),
      },
